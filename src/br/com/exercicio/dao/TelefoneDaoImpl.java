...
public class TelefoneDaoImpl implements Serializable{
    ...
    public void salvarTelefone(List<Telefone> telefones, int chaveEstrangeira, Connection conn) throws SQLException {
        String sql = "INSERT INTO telefone(tipo, numero, operadora, idPessoaSenac) VALUES(?, ?, ?, ?)";
    ...
    public void salvar(Connection conexao, String sql, Telefone telefone, int idEstrangeiro) throws SQLException {
        try {
